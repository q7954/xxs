var rule = {
    ...
    图片替换: 'https://www.dushe03.com=>https://vres.miximixi.me',
    预处理: $js.toString(() => {
        ...
        if (img_script) {
            ...
            log(img_host);
            rule.图片替换 = 'https://www.dushe03.com=>' + img_host;
        }
    }),
    ...
    一级f: `js:
    let urls = [
    'https://www.dushe03.com/show/1-----1-1.html',
    'https://www.dushe03.com/show/2-----1-1.html',
    'https://www.dushe03.com/show/3-----1-1.html',
    'https://www.dushe03.com/show/4-----1-1.html',
    'https://www.dushe03.com/show/6-----1-1.html',
    ];
    let filters = {};
    pdfa = jsp.pdfa;
    pdfh = jsp.pdfh;
